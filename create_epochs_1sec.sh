...
scp -r /rri_disks/eugenia/meltzer_lab/bilateral_squeeze/GRAND_DS/${subj}/bimanualsqueeze_grandDS.ds /rri_disks/eugenia/meltzer_lab/bilateral_squeeze/PROC/${subj}
