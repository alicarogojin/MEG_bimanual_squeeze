...
foreach run (001 002 003 004 005 006)
    ...
    set marker_pair1 = ("t104_noTap_L_antiphaseSlow t134_noTap_R_antiphaseSlow")
    set marker_pair2 = ("t114_noTap_L_antiphaseMedium t144_noTap_R_antiphaseMedium")
    set marker_pair3 = ("t124_noTap_L_antiphaseFast t154_noTap_R_antiphaseFast")
