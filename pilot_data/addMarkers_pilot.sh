...
foreach run (001 002 003 004 005 006)
    ...
    addMarker -f -n t101_blockStart_antiphaseSlow -s UPPT002 -l green -c 1010011000000000 ${dataset}
    addMarker -f -n t102_instructions_antiphaseSlow -s UPPT002 -l blue -c 0110011000000000 ${dataset}
    addMarker -f -n t103_tap_R_antiphaseSlow -s UPPT002 -l darkorange -c 1110011000000000 ${dataset} # portcode 103 tap antiphase: right hand first
    addMarker -f -n t104_noTap_R_antiphaseSlow -s UPPT002 -l deeppink -c 0001011000000000 ${dataset} # portcode 104 no tap antiphase: right hand first
    addMarker -f -n t133_tap_L_antiphaseSlow -s UPPT002 -l darkorange -c 1010000100000000 ${dataset} # portcode 133 tap antiphase: left hand first
    addMarker -f -n t134_noTap_L_antiphaseSlow -s UPPT002 -l deeppink -c 0110000100000000 ${dataset} # portcode 134 no tap antiphase: left hand first
    addMarker -f -n t105_blockEnd_antiphaseSlow -s UPPT002 -l red -c 1001011000000000 ${dataset}

    addMarker -f -n t111_blockStart_antiphaseMedium -s UPPT002 -l green -c 1111011000000000 ${dataset}
    addMarker -f -n t112_instructions_antiphaseMedium -s UPPT002 -l blue -c 0000111000000000 ${dataset}
    addMarker -f -n t113_tap_R_antiphaseMedium -s UPPT002 -l darkorange -c 1000111000000000 ${dataset} # portcode 113 tap antiphase: right hand first
    addMarker -f -n t114_noTap_R_antiphaseMedium -s UPPT002 -l deeppink -c 0100111000000000 ${dataset} # portcode 114 no tap antiphase: right hand first
    addMarker -f -n t143_tap_L_antiphaseMedium -s UPPT002 -l darkorange -c 1111000100000000 ${dataset} # portcode 143 tap antiphase: left hand first
    addMarker -f -n t144_noTap_L_antiphaseMedium -s UPPT002 -l deeppink -c 0000100100000000 ${dataset} # portcode 144 no tap antiphase: left hand first
    addMarker -f -n t115_blockEnd_antiphaseMedium -s UPPT002 -l red -c 1100111000000000 ${dataset}

    addMarker -f -n t121_blockStart_antiphaseFast -s UPPT002 -l green -c 1001111000000000 ${dataset}
    addMarker -f -n t122_instructions_antiphaseFast -s UPPT002 -l blue -c 0101111000000000 ${dataset}
    addMarker -f -n t123_tap_R_antiphaseFast -s UPPT002 -l darkorange -c 1101111000000000 ${dataset} # portcode 123 tap antiphase: right hand first
    addMarker -f -n t124_noTap_R_antiphaseFast -s UPPT002 -l deeppink -c 0011111000000000 ${dataset} # portcode 124 no tap antiphase: right hand first
    addMarker -f -n t153_tap_L_antiphaseFast -s UPPT002 -l darkorange -c 1001100100000000 ${dataset} # portcode 153 tap antiphase: left hand first
    addMarker -f -n t154_noTap_L_antiphaseFast -s UPPT002 -l deeppink -c 0101100100000000 ${dataset} # portcode 154 no tap antiphase: left hand first
    addMarker -f -n t125_blockEnd_antiphaseFast -s UPPT002 -l red -c 1011111000000000 ${dataset}

    addMarker -f -n t131_blockStart_rest -s UPPT002 -l green -c 1100000100000000 ${dataset}
    addMarker -f -n t132_instructions_rest -s UPPT002 -l blue -c 0010000100000000 ${dataset}
    addMarker -f -n t133_rest -s UPPT002 -l darkorange -c 1010000100000000 ${dataset}
    addMarker -f -n t135_blockEnd_rest -s UPPT002 -l red -c 1110000100000000 ${dataset}
end
